...
/**
 * Servlet implementation class pgupdate
 */
public class pgupdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i>0) {
			...
			pw.print("<p>Failes</p>");
			request.getRequestDispatcher("pgupdate.jsp").include(request,response);
		}
