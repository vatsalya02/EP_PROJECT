...
/**
 * Servlet implementation class ugservlet
 */
public class ugservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i>0) {
			...
			pw.print("<p>Failes</p>");
			request.getRequestDispatcher("ugadd_project.html").include(request,response);
		}
